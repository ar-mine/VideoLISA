...
if __name__ == "__main__":
    ...
    skip_list = [
        ...
        'WFtV4rV_ARg', 'pYcVzxzpZgM', 'd0Kn7Rt1D0U', 'MntLqxO53Ls', 'oDs05I0NyR8', 'BGKk5HmKZ5I',
        # DOWNLOAD_ERROR_AUTH
        ...
        'jSv0FIVspRA', 'vEV9P4Q3x_Q', 'WKB2mKTQo24', 'YcAqgVarvsM',
        ...
        'hJcm64kAVOo', 'UWH8RWYln0I', '0kClu-uz7aA',
        # TRIM_ERROR_EXCEPTION
        '-9FE-Gs40tc', 'RfCPnOwMYaI', '-sUhkJcjxYQ',
    ]
    labels, _ = download_dataset_parallel(dataset,
                                          max_data_number=2000,
                                          skip_list=skip_list, num_workers=2)
    json.dump(labels, open("labels/index.json", "w"), indent=2)
